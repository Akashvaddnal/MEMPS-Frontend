...
//   // Fetch and normalize backend data (now all strings)
...
//     // Convert to backend snake_case as required
//     const payload = {
//       equipmentId: formData.equipmentId,
//       acquisitionDate: formData.acquisitionDate ? new Date(formData.acquisitionDate).toISOString() : "",
//       warrantyExpirationDate: formData.warrantyExpirationDate ? new Date(formData.warrantyExpirationDate).toISOString() : "",
//       expectedEndOfLife: formData.expectedEndOfLife ? new Date(formData.expectedEndOfLife).toISOString() : "",
//     };
...
//   const handleSubmit = async () => {
//     // Transform camelCase to snake_case for backend, convert dates to ISO strings
//     const payload = {
//       equipment_id: formData.equipmentId,
//       acquisition_date: formData.acquisitionDate
//         ? new Date(formData.acquisitionDate).toISOString()
//         : null,
//       warranty_expiry: formData.warrantyExpirationDate
//         ? new Date(formData.warrantyExpirationDate).toISOString()
//         : null,
//       expected_end_of_life: formData.expectedEndOfLife
//         ? new Date(formData.expectedEndOfLife).toISOString()
//         : null,
//       maintenance_count: formData.maintenanceCount,
//       total_maintenance_cost: formData.totalMaintenanceCost,
//       last_maintenance_date: formData.lastMaintenanceDate
